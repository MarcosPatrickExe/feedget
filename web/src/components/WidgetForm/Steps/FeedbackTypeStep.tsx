...
interface IAddFeedbackProps { // "AddFeedbackProps" CORRESPONDE AO TIPO DO "PROPS" QUE SERÁ RECEBIDO NESSE COMPONENTE
...
export function FeedbackTypeStep( props : IAddFeedbackProps ){ 
            ...
            <div className="flex py-8 gap-2 w-full items-center"> 
                { Object.entries(feedbackTypes)// CONVERTENDO ATRIBUTOS DO OBJETO EM VETOR
                    .map( ([key, value])=>{
                            ...
                            return (// AQUI SÃO RENDERIZADOS OS BOTÕES COM OS TIPOS DE FEEDBACKs DISPONIVEIS (3)
